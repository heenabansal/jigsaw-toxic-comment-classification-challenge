...
from keras.layers import Input, Embedding, LSTM, GRU,Dense, Masking, Bidirectional, GlobalMaxPool1D, RepeatVector, Dropout, merge,TimeDistributed, Flatten, Permute, Lambda
...
roc_call = roc_callback([Xtrain,Ytrain])
early = EarlyStopping(monitor="val_loss", mode="min", patience=20)

model.fit(Xtrain, Ytrain, batch_size=BatchSize, epochs=n_Epochs, validation_split=0.1, 
          callbacks=[checkpoint_callback,tensorboard_callback,early,roc_call])
